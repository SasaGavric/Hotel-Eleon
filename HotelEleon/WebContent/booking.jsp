	...
	<div class="bg1">
		<div class="bg2">
			<div class="main">
				...
				<header>
					<h1>
						Hotel <span id="title">Eleon</span>
					</h1>
				...
				<div class="box">
					...
					<ul id="menu">
						...
						<li class="active"><a
							href="HotelControllerServlet?command=BOOKING_PAGE">Booking</a></li>
						...
						<div class="box1">
							<div class="wrapper">
								<c:if test="${availableRooms }">
										...
										<fieldset>
											<div class="row">
												<input type="text" name="firstName" required="required"
													maxlength="25" class="input"> First Name:
											</div>
											<div class="row">
												<input type="text" name="lastName" required="required"
													maxlength="25" class="input"> Last Name:
											</div>
											<div class="row">
												<input type="text" name="email" required="required"
													maxlength="30" class="input"> E-Mail Address:
											</div>
											<div class="row">
												<input type="text" name="phone" required="required"
													maxlength="20" class="input"> Phone:
											</div>
											<div class="row">
									...
									<div class="col2 pad">
										<h2>
											<img src="images/title_marker1.jpg" alt=""> Rooms
										</h2>
						...
						<div class="pad">
							<div class="wrapper line3">
								<div class="col2">
									<h2>About Booking</h2>
									<p class="pad_bot1">
										<strong class="color2">Chose one of our 3 luxurious
											room types </strong>
									</p>
									...
									<div class="wrapper">
										...
										<p class="pad_bot2">
											When You book room you need to check in hotel on reception
											with your <br>id card or passport.
										</p>
									</div>
								...
								<div class="col1 pad_left1">
									<h2>Booking Info</h2>
									<p class="pad_bot1">
										<strong class="color2">All other information You can
											get on our reception</strong>
									</p>
